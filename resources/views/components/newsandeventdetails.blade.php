...
<div class="breadcumb-wrapper" data-bg-src={!! breadcrumbimage()->_image ?? "" !!}>
      <div class="container">
        <div class="breadcumb-content">
          <h1 class="breadcumb-title">{!! $newsandevent->_title ?? '' !!}</h1>
          <ul class="breadcumb-menu">
            <li><a href="{{ url('/news-events') }}">News & Events</a></li>
            <li>{!! $newsandevent->_title ?? '' !!}</li>
          </ul>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-xxl-12 col-lg-7">
            <div class="ot-blog blog-single">
              <div class="blog-img">
                <img src={!! $newsandevent->_image ?? '' !!} alt="Blog Image" style="width:100%;"/>
              </div>
              <div class="blog-content">
                <div class="blog-meta">
                  
                  <a href="#"
                    ><i class="fa-solid fa-calendar-days"></i>{!! date("F j, Y", strtotime($newsandevent->created_at ?? "")); !!}</a
                  >
                </div>
                <h2 class="blog-title">
                {!! $newsandevent->_title ?? '' !!}
