...
<div class="breadcumb-wrapper" data-bg-src={!! breadcrumbimage()->_image ?? "" !!}>
      <div class="container">
        <div class="breadcumb-content">
          <h1 class="breadcumb-title"> Class Routine</h1>
        ...
        <div class="row">
          <div class="col-xxl-12">
            <div class="ot-blog blog-single">
              <div class="blog-img">
              <iframe src="{!! $classroutine->_image ?? '' !!}" style="width: 100%; height:700px;"></iframe>

              </div>
              <div class="blog-content">
                <div class="blog-meta">
                  <a href="#"
                    ><i class="fa-solid fa-calendar-days"></i>{!! date("F j, Y", strtotime($classroutine->created_at ?? "")); !!}</a
                  >
                </div>
                <h2 class="blog-title">
                 {!! $classroutine->_title ?? "" !!}
                ...
                <p>
                {!! $classroutine->_subtitle ?? "" !!}
                </p>
                <p>
                {!! $classroutine->_description ?? "" !!}
                </p>
