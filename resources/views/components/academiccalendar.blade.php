...
<div class="breadcumb-wrapper" data-bg-src={!! breadcrumbimage()->_image ?? "" !!}>
      <div class="container">
        <div class="breadcumb-content">
          <h1 class="breadcumb-title">Academic Calendar</h1>
        ...
        <div class="row">
          <div class="col-xxl-12">
            <div class="ot-blog blog-single">
              <div class="blog-img">
              <iframe src="{!! $academiccalendar->_image ?? '' !!}" style="width: 100%; height:700px;"></iframe>

              </div>
              <div class="blog-content">
                <div class="blog-meta">
                  <a href="#"
                    ><i class="fa-solid fa-calendar-days"></i>{!! date("F j, Y", strtotime($academiccalendar->created_at ?? "")); !!}</a
                  >
                </div>
                <h2 class="blog-title">
                 {!! $academiccalendar->_title ?? "" !!}
                </h2>
                <p>
                {!! $academiccalendar->_subtitle ?? "" !!}
                </p>
                <!--<p>-->
                <!--{!! $academiccalendar->_description ?? "" !!}-->
                <!--</p>-->
                </div>
              </div>
            </div>
